        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('admin.sub-categories.create') }}" class="btn btn-theme">Add New Sub Category</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                            ...
                            @else
                                @foreach ($sub_categories as $sub_category)
                                    <tr>
                                        ...
                                        <td>{{ $sub_category->category ? $sub_category->category->name : 'N/A' }}</td>
                                        ...
                                        <td>
                                            ...
                                            @endcan
                                            @can('Delete Sub Categories')
                                                <a href="#" class="text-danger w-4 h-4 mr-1 btn-delete"
                                                    data-url="{{ route('admin.sub-categories.delete', $sub_category->id) }}"
