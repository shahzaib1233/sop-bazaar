...
@section('title', 'Account Statuses - Admin Dashboard')
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="" class="btn btn-theme">Add New Account Status</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                            ...
                            @else
                                @foreach ($accountStatuses as $status)
                                    <tr>
                                        ...
                                        <td>
                                            @can('Edit Categories')
                                                <a href="{{ route('admin.categories.edit' , $status->id) }}"
                                            ...
                                            @can('Delete Categories')
                                                <a href="#" class="text-danger w-4 h-4 mr-1 btn-delete"
                                                    data-url="{{ route('admin.categories.delete', $status->id) }}"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Remember all the account statuses associated with this status will also be deleted.</p>
